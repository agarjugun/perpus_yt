...
<style>
    ...
    .card {
    background-color: #212529; /* Ganti dengan warna yang diinginkan */
    color: #fff; /* Ganti dengan warna teks yang sesuai */
    text-align: center; /* Atur posisi teks */
        width: 400px; /* Ganti ukuran sesuai kebutuhan */
        padding: 10px; /* Ganti padding sesuai kebutuhan */
        border-radius: 20px; /* Ganti border-radius sesuai kebutuhan */
  }
  body {
  display: flex;
  align-items: center;
  ...
  background-attachment: fixed;
    ...
    <div class="layout-card-custom mt-4">
       ...
       <div class="card" style="width: 10rem;">
        <img src="../imgDB/<?= $item["cover"]; ?>" class="card-img-top" alt="coverBuku" height="200px">
         <div class="card-body">
...
<div class="modal-dialog modal-dialog-centered">
    ...
    <form method="post" enctype="multipart/form-data" action="">
      ...
      <!-- Modal body --><div class="modal-body bg-dark">
      <div class="row">
    <div class="col-md-6">
    ...
    <div class="col-md-6">
    <div>
            <strong class="text-white">Judul:</strong> <p class="text-white"><?php echo $item['judul']; ?></p>
        </div>
        <div>
            <strong class="text-white">Kategori:</strong> <p class="text-white"><?php echo $item['kategori']; ?></p>
        </div>
        <div>
            <strong class="text-white">Pengarang:</strong> <p class="text-white"><?php echo $item['pengarang']; ?></p>
        </div>
        <div>
            <strong class="text-white">Penerbit:</strong> <p class="text-white"><?php echo $item['penerbit']; ?></p>
        </div>
        <div>
            <strong class="text-white">Tahun Terbit:</strong> <p class="text-white"><?php echo $item['thn_terbit']; ?></p>
        </div>
        <div>
            <strong class="text-white">Deskripsi:</strong> <p class="text-white"><?php echo $item['deskripsi']; ?></p>
        </div>
    </div>
</div>
 </div>
      ...
      <div class="modal-footer bg-dark">
        <a href="pinjam.php?id=<?=$item["id_buku"];?>" class="btn btn-primary">Pinjam</a>
      </div>
      </form>
    </div>
  </div>
